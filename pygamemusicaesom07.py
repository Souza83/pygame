...
x = int(largura/2)  # Variável que representa a posição horizontal (eixo x = largura da tela / 2 = inicia no meio da tela)
y = int(altura/2)  # Variável que representa a posição vertical (eixo y = altura da tela / 2 = inicia no meio da tela)
...
while True:
    ...
    texto_formatado = fonte.render(mensagem, False, (255, 255, 255))  # Variável que formata (mensagem, pixelização e cor)
